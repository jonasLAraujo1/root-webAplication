...
<body>
	...
	<div class="card" style="width: 70%;margin-left: 15%;background-color: #f8f9fa">
		<div class="card-body">
			<h2>Consolidar Reunião</h2>
			<form class="form-inline"  method="post" action="ligacao_banco_consolidar.php">
				<dl>
					<dt>ID</dt>
					<dt><input name="cod" type="text" readonly value=<?php echo $codigoURL ?> ></dt>
					<dt><br></dt>
					<dt>Tipo</dt>
					<dt>
						<select name="novoTipo" disabled readonly class="form-control">
					...
					<dt>Presidente</dt>
					<dt>
						<select   name="novoPresidente" disabled readonly class="form-control">
					...
					<dt><br></dt>
					<dt>Hora de Inicio
						<input type="time" name="novoHoraI" required name= novoHoraI class="form-control" value=<?php echo $atualI ?> >
						Termino
						<input type="time" name="novoHoraF" required name= novoHoraF class="form-control" value=<?php echo $atualF ?>>
					</dt>
					<dt><br></dt>
					<dt>Pauta</dt>
					<dt>
					...
					<dt>Deliberações</dt>
					<dt>
						<textarea name="novoDeliberacoes"  class="form-control" rows='4' cols="60" ><?php echo $atualDeliberacoes ?>
						</textarea> 
					</dt>
					<dt><br></dt>
					<dt>Observações</dt>
					...
					<dt>Participantes</dt>
					<dt>
						<textarea name="novoParticipantes"  class="form-control" rows='5' cols="60" ><?php echo $atualParticipantes ?> </textarea>
					</dt>
